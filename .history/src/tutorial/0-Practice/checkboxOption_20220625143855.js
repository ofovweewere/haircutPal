...
const CheckboxOption = ({title, description, cost, idd}) => {
  ...
  const [displayVal, setDisplayVal] = useState('hidden');
  return (
    <>
      <div
      ...
      >
        ...
        >
          <div className="whiteParagraph">
            ...
            <p className='secondItem' visibility={displayVal}><span className='exclamation'><i class="fa fa-exclamation-circle" aria-hidden="true"></i></span> You can select up to 1 item</p>
          </div>
