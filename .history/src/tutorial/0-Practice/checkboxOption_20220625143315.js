      ...
      >
        ...
        >
          <div className="whiteParagraph">
            ...
            <p className='secondItem' display='hidden'><span className='exclamation'><i class="fa fa-exclamation-circle" aria-hidden="true"></i></span> You can select up to 1 item</p>
          </div>
